...
function getValueForKeyOrThrow<TKey, TValue>(map: Map<TKey, TValue>, key: TKey): TValue {
...
export function getGlobalUniqueIdForClass(moduleId: WebpackModuleId, className: string): number {
	...
	const moduleClassRegistry = getValueForKeyOrThrow(moduleClassRegistries, moduleId);
